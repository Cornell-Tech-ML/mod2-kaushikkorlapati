...
def test_reduce_forward_one_dim() -> None:
    ...
    t_summed = t.sum(0)
    # shape (2)
    print(f"Shape of t_summed: {t_summed.shape}")
    print(f"Value of t_summed: {t_summed}")
    t_sum_expected = tensor([[11, 16]])
    print(f"Shape of t_summed: {t_sum_expected.shape}")
    print(f"Value of t_summed: {t_sum_expected}")
